...
bitsadmin /transfer mydownloadjob  /download /priority normal https://ars.bnb.gov.br/global-protect/getmsi.esp?version=64&platform=windows\GlobalProtect64.exe C:\Suporte\GlobalProtect64.msi
